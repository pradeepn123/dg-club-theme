if (!customElements.get('variant-selects')) {
  ...
  class VariantSelects extends HTMLElement {
    ...
    getSectionsToRender() {
      return [`price-${this.dataset.section}`, `price-${this.dataset.section}--sticky`, `product-image-${this.dataset.section}--sticky`, `inventory-${this.dataset.section}`, `sku-${this.dataset.section}`, `quantity-${this.dataset.section}`, `product--data-variant-json-script-${this.dataset.section}`];
    }
      ...
      fetch(`${this.dataset.url}?variant=${this.currentVariant.id}&section_id=${this.dataset.section}`)
        ...
        .then((responseText) => {
          ...
          if (enableAddBtn) {
            ...
            this.toggleAddButton(true, window.theme.variantStrings.addToCart);
          }
        });
    }
    ...
    connectedCallback() {
      if (!this.sticky) {
        if (this.dataset.templateSuffix == "products_without_editor") {
          ...
          this.form.addEventListener('submit', this.handleDynamicVariant.bind(this));
        } else {
